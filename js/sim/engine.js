    ...
    function createSimulationEngine({ store, eventBus }) {
        ...
        function stepSimulation() {
            ...
            try {
                ...
                console.error('[SimEngine] tick failed', error);
            } finally {
        ...
        function startSimulation(options = {}) {
            ...
            console.info('[SimEngine] Simulation started');
            stepSimulation();
        ...
        function setScenario(nextScenario) {
            if (!EcoFlowSim.scenarios[nextScenario]) {
                console.warn(`[SimEngine] Unknown scenario: ${nextScenario}`);
                return;
            }
            ...
            console.info(`[SimEngine] Scenario switched to ${nextScenario}`);
            eventBus.emit('toast', {
                type: 'info',
        ...
        function queueValveCommand(valveId, desiredState, retryDepth = 0) {
            ...
            if (!valve) {
                console.warn(`[SimEngine] Valve not found: ${valveId}`);
                return;
            }
